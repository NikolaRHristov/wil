...
public:
    ...
    //! specified Returns address of the managed struct
...
#if defined(__WIL_WINBASE_) && defined(__NOTHROW_T_DEFINED) && !defined(__WIL_WINBASE_NOTHROW_T_DEFINED_STL) && \
    defined(WIL_RESOURCE_STL) && WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
...
{
    static_assert(
        wistd::is_trivially_destructible<T>::value,
        "T has a destructor that won't be run when used with this function; use make_unique instead");
    ...
    size_t size)
{
    ...
    static_assert(
        wistd::is_trivially_destructible<E>::value,
        "E has a destructor that won't be run when used with this function; use make_unique instead");
...
#if defined(_COMBASEAPI_H_) && !defined(__WIL__COMBASEAPI_H_) && \
    WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_SYSTEM) && !defined(WIL_KERNEL_MODE)
...
#if defined(_COMBASEAPI_H_) && !defined(__WIL__COMBASEAPI_H_APP) && \
    WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_SYSTEM) && !defined(WIL_KERNEL_MODE)
...
#if defined(__ROAPI_H_) && !defined(__WIL__ROAPI_H_APP) && \
    WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_SYSTEM) && (NTDDI_VERSION >= NTDDI_WIN8)
...
#if defined(_WINGDI_) && !defined(__WIL_WINGDI_) && WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP) && !defined(NOGDI) && \
    !defined(WIL_KERNEL_MODE)
...
template <typename T = void>
using unique_midl_ptr = wistd::unique_ptr<T, midl_deleter>;
...
#if defined(__WIL_OBJBASE_H_) && defined(__WIL_WINBASE_) && !defined(__WIL_OBJBASE_AND_WINBASE_H_) && \
...
#if defined(_INC_USERENV) && !defined(__WIL_INC_USERENV) && \
    WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_SYSTEM) && !defined(WIL_KERNEL_MODE)
...
#if defined(__WINEVT_H__) && !defined(__WIL_INC_EVT_HANDLE) && \
    WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_PKG_EVENTLOGSERVICE) && !defined(WIL_KERNEL_MODE)
...
#if defined(_NETIOAPI_H_) && defined(_WS2IPDEF_) && defined(MIB_INVALID_TEREDO_PORT_NUMBER) && !defined(__WIL_NETIOAPI_H_) && \
    WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
...
#if defined(_PROCESSTHREADSAPI_H_) && !defined(__WIL_PROCESSTHREADSAPI_H_DESK_SYS) && \
    WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_SYSTEM) && !defined(WIL_KERNEL_MODE)
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_SYSTEM) && defined(_CFGMGR32_H_) && \
    (WINVER >= _WIN32_WINNT_WIN8) && !defined(__WIL_CFGMGR32_H_)
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_SYSTEM) && defined(_SWDEVICE_H_) && \
    (WINVER >= _WIN32_WINNT_WIN8) && !defined(__WIL_SWDEVICE_H_)
