...
#pragma section("minATL$__z", read)
        ...
        public:
            ...
            ModuleBase() throw()
            {
                ...
                __WRL_ASSERT__(
                    ::InterlockedCompareExchangePointer(reinterpret_cast<void* volatile*>(&module_), this, nullptr) == nullptr &&
...
#ifdef _DEBUG
                __WRL_ASSERT__(
                    ::InterlockedCompareExchangePointer(reinterpret_cast<void* volatile*>(&module_), nullptr, this) == this &&
                    "The module was already instantiated");
#else
                module_ = nullptr;
#endif
            ...
            STDMETHOD(RegisterWinRTObject)(
                _In_opt_z_ const wchar_t*, _In_z_ const wchar_t** activatableClassIds, _Inout_ RO_REGISTRATION_COOKIE* cookie, unsigned int) = 0;
...
#pragma warning(suppress : 6102) // '*ppvObject' is used but may not be initialized
        ...
        struct VerifyInterfaceHelper<ClassicCom, I, doStrictCheck, false>
        {
            static void Verify() throw()
            {
                ...
                static_assert(
                    __is_base_of(IUnknown, I) && !__is_base_of(IInspectable, I) && !(doStrictCheck && IsSame<IUnknown, I>::value),
        ...
        struct VerifyInterfaceHelper<WinRtClassicComMix, I, doStrictCheck, false>
        {
            static void Verify() throw()
            {
                ...
                static_assert(
                    __is_base_of(IUnknown, I) && (doStrictCheck ? !(IsSame<IInspectable, I>::value || IsSame<IUnknown, I>::value)
        ...
        struct VerifyInheritanceHelper
        {
            ...
            {
                static_assert(
                    Details::IsBaseOfStrict<typename InterfaceTraits<Base>::Base, typename InterfaceTraits<I>::Base>::value,
...
#pragma endregion //  helper types
    ...
    protected:
        ...
        HRESULT CanCastTo(REFIID riid, _Outptr_ void** ppv) throw()
        {
            ...
            return (Details::InterfaceTraits<I0>::CanCastTo(this, riid, ppv) || Details::InterfaceTraits<I1>::CanCastTo(ptr, riid, ppv) ||
                    Details::InterfaceTraits<I2>::CanCastTo(ptr, riid, ppv) || Details::InterfaceTraits<I3>::CanCastTo(ptr, riid, ppv) ||
                    Details::InterfaceTraits<I4>::CanCastTo(ptr, riid, ppv) || Details::InterfaceTraits<I5>::CanCastTo(ptr, riid, ppv) ||
                    Details::InterfaceTraits<I6>::CanCastTo(ptr, riid, ppv) || Details::InterfaceTraits<I7>::CanCastTo(ptr, riid, ppv) ||
                    Details::InterfaceTraits<I8>::CanCastTo(ptr, riid, ppv) || Details::InterfaceTraits<I9>::CanCastTo(ptr, riid, ppv))
                       ? S_OK
                       : E_NOINTERFACE;
        }
        ...
        static const unsigned long IidCount = Details::InterfaceTraits<I0>::IidCount + Details::InterfaceTraits<I1>::IidCount +
    ...
    template <typename DerivedType, typename BaseType, bool hasImplements, typename I1, typename I2, typename I3, typename I4, typename I5, typename I6, typename I7, typename I8, typename I9>
    ...
    protected:
        ...
        static const unsigned long IidCount = Details::InterfaceTraits<I1>::IidCount + Details::InterfaceTraits<I2>::IidCount +
...
#pragma region Implements helper templates
        ...
        struct __declspec(novtable) ImplementsHelper<RuntimeClassFlagsT, doStrictCheck, I0, TInterfaces...>
            : I0, AdjustImplements<RuntimeClassFlagsT, true, TInterfaces...>::Type
        {
        ...
        struct __declspec(novtable) ImplementsHelper<RuntimeClassFlagsT, doStrictCheck, CloakedIid<I0>, I1, TInterfaces...>
            : AdjustImplements<RuntimeClassFlagsT, doStrictCheck, I0>::Type, AdjustImplements<RuntimeClassFlagsT, true, I1, TInterfaces...>::Type
        {
            template <typename OtherRuntimeClassFlagsT, bool OtherDoStrictCheck, typename... TOtherInterfaces>
            friend struct ImplementsHelper;
            template <unsigned int RuntimeClassTypeT>
        ...
        struct __declspec(novtable)
            ImplementsHelper<RuntimeClassFlagsT, doStrictCheck, ChainInterfaces<C0, C1, C2, C3, C4, C5, C6, C7, C8, C9>, TInterfaces...>
            : ChainInterfaces<C0, C1, C2, C3, C4, C5, C6, C7, C8, C9>, AdjustImplements<RuntimeClassFlagsT, true, TInterfaces...>::Type
        {
            template <typename OtherRuntimeClassFlagsT, bool OtherDoStrictCheck, typename... TOtherInterfaces>
            friend struct ImplementsHelper;
            template <unsigned int RuntimeClassTypeT>
        ...
        struct __declspec(novtable)
            ImplementsHelper<RuntimeClassFlagsT, doStrictCheck, MixIn<DerivedType, BaseMixInType, hasImplements>, TInterfaces...>
        ...
        protected:
            ...
            unsigned long GetIidCount() throw()
            {
                return static_cast<BaseMixInType*>(static_cast<DerivedType*>(this))->GetIidCount() + BaseType::GetIidCount();
            }
...
#pragma endregion // Implements helper templates
    ...
    struct __declspec(novtable) Implements : Details::AdjustImplements<RuntimeClassFlags<WinRt>, true, I0, TInterfaces...>::Type, Details::ImplementsBase
    {
    public:
    ...
    struct __declspec(novtable) Implements<RuntimeClassFlags<flags>, I0, TInterfaces...>
        : Details::AdjustImplements<RuntimeClassFlags<flags>, true, I0, TInterfaces...>::Type, Details::ImplementsBase
    {
    public:
    ...
    class FtmBase
        : public Implements<::Microsoft::WRL::RuntimeClassFlags<WinRtClassicComMix>, ::Microsoft::WRL::CloakedIid<::IMarshal>>,
          ...
          private ::Microsoft::WRL::Details::FtmBaseMarker
    {
        ...
        using Super = Implements<::Microsoft::WRL::RuntimeClassFlags<WinRtClassicComMix>, ::Microsoft::WRL::CloakedIid<::IMarshal>>;
...
#pragma warning(suppress : 6101) // PREFast cannot see through the smart-pointer invocation
        STDMETHOD(GetUnmarshalClass)(
            _In_ REFIID riid, _In_opt_ void* pv, _In_ DWORD dwDestContext, _Reserved_ void* pvDestContext, _In_ DWORD mshlflags, _Out_ CLSID* pCid) override
        {
            if (marshaller_)
            {
...
#pragma warning(suppress : 6101) // PREFast cannot see through the smart-pointer invocation
        STDMETHOD(GetMarshalSizeMax)(
            _In_ REFIID riid, _In_opt_ void* pv, _In_ DWORD dwDestContext, _Reserved_ void* pvDestContext, _In_ DWORD mshlflags, _Out_ DWORD* pSize) override
        {
            if (marshaller_)
            {
        ...
        STDMETHOD(MarshalInterface)(
            _In_ IStream* pStm, _In_ REFIID riid, _In_opt_ void* pv, _In_ DWORD dwDestContext, _Reserved_ void* pvDestContext, _In_ DWORD mshlflags) override
        {
            if (marshaller_)
            {
...
#pragma warning(suppress : 6101) // PREFast cannot see through the smart-pointer invocation
        ...
        static HRESULT CreateGlobalInterfaceTable(_Out_ IGlobalInterfaceTable** git) throw()
        {
            *git = nullptr;
            return ::CoCreateInstance(
                CLSID_StdGlobalInterfaceTable, nullptr, CLSCTX_INPROC_SERVER, __uuidof(IGlobalInterfaceTable), reinterpret_cast<void**>(git));
        }
    ...
    namespace Details
    {
        ...
        protected:
            PerfCountersBase() throw() : addRefCount_(0), releaseCount_(0), queryInterfaceCount_(0)
            {
            }
...
#define DETAILS_RTCLASS_FLAGS_ARGUMENTS(RuntimeClassFlagsT) \
    RuntimeClassFlagsT, (RuntimeClassFlagsT::value & InhibitWeakReference) == 0, (RuntimeClassFlagsT::value & WinRt) == WinRt, \
...
// (compiler may decide to re-fetch the value later on, which in some cases can break code)
        ...
        FORCEINLINE
        LONG ReadULongPtrNoFence(_In_ _Interlocked_operand_ DWORD const volatile* Source)
        ...
        FORCEINLINE
        LONG64
        ReadULongPtrNoFence(_In_ _Interlocked_operand_ DWORD64 const volatile* Source)
...
#error Unsupported architecture.
        ...
        protected:
            template <unsigned int RuntimeClassTypeT>
            friend class Details::RuntimeClassBaseT;
            using ImplementsHelper =
                typename Details::AdjustImplements<RuntimeClassFlagsT, false, typename IInspectableInjector<I0>::InspectableIfNeeded, I0, IWeakReferenceSource, TInterfaces...>::Type;
            using Super = RuntimeClassBaseT<RuntimeClassFlagsT::value>;
...
#pragma warning(pop) // C6388
        ...
        template <typename RuntimeClassFlagsT, bool implementsWeakReferenceSource, bool implementsInspectable, bool implementsFtmBase, typename... TInterfaces>
...
#pragma warning(suppress : 6101) // Function only used internally and the value of 'ppvObject' is only used if *handled is true
    ...
    namespace Details
    {
        ...
        class WeakReferenceImpl final : public ::Microsoft::WRL::RuntimeClass<RuntimeClassFlags<ClassicCom>, IWeakReference>,
        ...
        unsigned long RuntimeClassImpl<RuntimeClassFlagsT, true, true, false, I0, TInterfaces...>::InternalAddRef() throw()
        {
            ...
            for (;;)
            {
                if (!IsValueAPointerToWeakReference(currentValue.rawValue))
                {
                    ...
                    INT_PTR previousValue = reinterpret_cast<INT_PTR>(UnknownInterlockedCompareExchangePointerForIncrement(
        ...
        template <class RuntimeClassFlagsT, typename I0, typename... TInterfaces>
        COM_DECLSPEC_NOTHROW HRESULT RuntimeClassImpl<RuntimeClassFlagsT, true, true, false, I0, TInterfaces...>::GetWeakReference(
            ...
            *weakReference = nullptr;
            ...
            for (;;)
            {
                ...
                previousValue = reinterpret_cast<INT_PTR>(UnknownInterlockedCompareExchangePointer(
                    reinterpret_cast<PVOID*>(&(this->refCount_.ifHighBitIsSetThenShiftLeftToYieldPointerToWeakReference)),
...
public: \
    ...
    STDMETHOD(GetIids)( \
        _Out_ ULONG * iidCount, \
        _When_(*iidCount == 0, _At_(*iids, _Post_null_)) _When_(*iidCount > 0, _At_(*iids, _Post_notnull_)) _Result_nullonfailure_ IID * \
            *iids) override \
    { \
...
public: \
    ...
    { \
        ...
        static_assert( \
            ...
            "Incorrect usage of IClassFactory interface. Make sure that your RuntimeClass doesn't implement IClassFactory interface use ::Windows::WRL::ClassFactory instead or 'MixInHelper' macro is not used on ::Windows::WRL::ClassFactory"); \
        return RuntimeClassT::QueryInterface(riid, ppvObject); \
    } \
    STDMETHOD_(ULONG, Release)() \
    { \
...
#define WrlCreatorMapIncludePragmaEx(className, group) \
    static_assert(false, "It's required to include 'wrl/module.h' to be able to use 'WrlCreatorMapIncludePragmaEx' macro");
#endif

#ifndef WrlCreatorMapIncludePragma
#define WrlCreatorMapIncludePragma(className) \
    static_assert(false, "It's required to include 'wrl/module.h' to be able to use 'WrlCreatorMapIncludePragma' macro");
#endif

#ifndef ActivatableClassWithFactoryEx
#define ActivatableClassWithFactoryEx(className, factory, groupId) \
    static_assert(false, "It's required to include 'wrl/module.h' to be able to use 'ActivatableClassWithFactoryEx' macro");
#endif

#ifndef ActivatableClassWithFactory
#define ActivatableClassWithFactory(className, factory) \
    static_assert(false, "It's required to include 'wrl/module.h' to be able to use 'ActivatableClassWithFactory' macro");
#endif
...
#define ActivatableStaticOnlyFactoryEx(factory, serverName) \
    static_assert(false, "It's required to include 'wrl/module.h' to be able to use 'ActivatableStaticOnlyFactoryEx' macro");
#endif

#ifndef ActivatableStaticOnlyFactory
#define ActivatableStaticOnlyFactory(factory) \
    static_assert(false, "It's required to include 'wrl/module.h' to be able to use 'ActivatableStaticOnlyFactory' macro");
#endif

#ifndef CoCreatableClassWithFactoryEx
#define CoCreatableClassWithFactoryEx(className, factory, groupId) \
    static_assert(false, "It's required to include 'wrl/module.h' to be able to use 'CoCreatableClassWithFactory' macro");
#endif
...
#define CoCreatableClassWrlCreatorMapInclude(className) \
    static_assert(false, "It's required to include 'wrl/module.h' to be able to use 'CoCreatableClassWrlCreatorMapInclude' macro");
#endif
